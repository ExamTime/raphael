...
(function () {
    ...
    var loaded,
        ...
        supportMouse = ('onmousemove' in g.win), // arbitrary event chosen
        E = "",
        S = " ",
        Str = String,
        split = "split",
    ...
    addEvent = (function () {
        if (g.doc.addEventListener) {
            return function (obj, type, fn, element) {
                var realName = (supportsTouch && !supportMouse) && touchMap[type] ? touchMap[type] : type,
                    f = function (e) {
                        var scrollY = g.doc.documentElement.scrollTop || g.doc.body.scrollTop,
                            scrollX = g.doc.documentElement.scrollLeft || g.doc.body.scrollLeft,
                            x = e.clientX + scrollX,
                            y = e.clientY + scrollY;
                    if ((supportsTouch && !supportMouse) && touchMap[has](type)) {
    ...
    elproto.drag = function (onmove, onstart, onend, move_scope, start_scope, end_scope) {
        function start(e) {
            ...
            eve("drag.start." + this.id, start_scope || move_scope || this, x + scrollX, y + scrollY, e);
        }
        this._drag = {};
